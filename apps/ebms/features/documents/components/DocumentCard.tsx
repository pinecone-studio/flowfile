...
//   return (
//     <div className="grid grid-cols-[2fr,1.5fr,1fr,1fr,1.5fr,1fr,1.2fr,0.2fr] items-center gap-4 px-6 py-4 rounded-2xl hover:bg-white/5 transition-all duration-300 group border border-transparent hover:border-white/5">
//       {/* Document Name */}
...
//       {/* Latest Action (Figma дээрх ногоон товч) */}
//       <div>
...
//       {/* Date */}
//       <div className="text-[13.5px] text-gray-400">Jun 15, 2026</div>

//       {/* Missing Signatures */}
//       <div className="flex items-center gap-2">
//         <div
//           className={`w-2 h-2 rounded-full ${document.status === 'completed' ? 'bg-green-500' : 'bg-yellow-500 animate-pulse'}`}
//         />
...
//           <div
//             key={i}
//             className="w-7 h-7 rounded-full border-2 border-[#0a1529] overflow-hidden transition-transform hover:translate-y-[-2px] hover:z-10 cursor-pointer"
//           >
//             <img
